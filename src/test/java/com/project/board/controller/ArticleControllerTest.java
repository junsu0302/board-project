...
@Import({SecurityConfig.class, FormDataEncoder.class}) // 설정한 SecurityConfig 적용
...
class ArticleControllerTest {
    ...
    @MockBean private ArticleService articleService; // 잠시 사용하고 연결을 끊어줌
    @MockBean private PaginationService paginationService; // 잠시 사용하고 연결을 끊어줌
